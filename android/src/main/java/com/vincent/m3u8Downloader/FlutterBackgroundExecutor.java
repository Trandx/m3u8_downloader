 ...
 * @Desc: Initialise l'isolation de l'arrière-plan du planificateur de 
 callback d'exécution pour appeler le callback Dart lorsque l'arrière-plan est démarré.
 */
